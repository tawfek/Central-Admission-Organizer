import { Languages, Moon, Sun, Monitor, UserRound } from "lucide-react"
...
export function AppControls() {
  ...
  return (
    <div className="no-print flex flex-wrap items-center gap-2 rounded-xl border border-zinc-200/80 bg-white/90 p-2 shadow-sm backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/90">
      {isTelegram && user && (
        <div className="flex h-9 max-w-[180px] items-center gap-2 rounded-lg bg-zinc-100 px-3 text-xs font-medium text-zinc-700 dark:bg-zinc-900 dark:text-zinc-200">
